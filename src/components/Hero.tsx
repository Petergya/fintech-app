  ...
  return (
    <div className="flex flex-col items-center justify-center bg-orange-200 p-4 mt-4 ">
      ...
      <p className="mb-8 text-center text-xs">
        This is a fintech application for TV subscriptions, buying data,
      ...
      <div className="bg- p-10 rounded-md bg-black">
        ...
        <ul className="flex space-x-6 mt-8 justify-center text-xs">
          <li>
            <Link
              href="/tvsubscription"
          ...
          <li>
            <Link href="/buydata" className="text-blue-600 hover:underline">
              Data
            </Link>
          </li>
          <li>
            <Link href="/buyairtime" className="text-blue-600 hover:underline">
              Airtime
            </Link>
          </li>
          <li>
